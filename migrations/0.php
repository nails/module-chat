...
namespace Nails\Database\Migration\NailsappModuleChat;
    ...
    public function execute()
    {
        ...
        $this->query("
            CREATE TABLE `{{NAILS_DB_PREFIX}}chat_room_message` (
                ...
                CONSTRAINT `{{NAILS_DB_PREFIX}}chat_room_message_ibfk_3` FOREIGN KEY (`room_id`) REFERENCES `{{NAILS_DB_PREFIX}}chat_room` (`id`) ON DELETE CASCADE,
        ...
        $this->query("
            CREATE TABLE `{{NAILS_DB_PREFIX}}chat_room_user` (
                ...
                CONSTRAINT `{{NAILS_DB_PREFIX}}chat_room_user_ibfk_3` FOREIGN KEY (`room_id`) REFERENCES `{{NAILS_DB_PREFIX}}chat_room` (`id`) ON DELETE CASCADE,
